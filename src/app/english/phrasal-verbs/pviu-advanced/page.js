...
const bookData = {
  ...
  cover:   "/books/pviu-advanced.jpg",
  subject: "phrasal-verbs",
  bookId:  "pviu-advanced",
  sections: [
    {
      title: "Section 1 — Learning about Phrasal Verbs",
      units: [
        { id: "unit-1",  title: "Unit 1 — Phrasal verbs: what are they and how are they used?" },
        { id: "unit-2",  title: "Unit 2 — Grammar of phrasal verbs"                            },
        { id: "unit-3",  title: "Unit 3 — Phrasal nouns"                                       },
        { id: "unit-4",  title: "Unit 4 — Phrasal adjectives"                                  },
      ],
    },
    {
      title: "Section 2 — Interesting Aspects of Phrasal Verbs",
      units: [
        { id: "unit-5",  title: "Unit 5 — Collocation and phrasal verbs" },
        { id: "unit-6",  title: "Unit 6 — Register"                      },
        { id: "unit-7",  title: "Unit 7 — Meaning and metaphor"          },
        { id: "unit-8",  title: "Unit 8 — Idioms using phrasal verbs"    },
      ],
    },
    {
      title: "Section 3 — Key Particles",
      units: [
        { id: "unit-9",  title: "Unit 9 — Around and about" },
        { id: "unit-10", title: "Unit 10 — Down"            },
        { id: "unit-11", title: "Unit 11 — In"              },
        { id: "unit-12", title: "Unit 12 — Off"             },
        { id: "unit-13", title: "Unit 13 — On"              },
        { id: "unit-14", title: "Unit 14 — Out"             },
        { id: "unit-15", title: "Unit 15 — Up"              },
      ],
    },
    {
      title: "Section 4 — Concepts",
      units: [
        { id: "unit-16", title: "Unit 16 — Time"                  },
        { id: "unit-17", title: "Unit 17 — Cause and effect"      },
        { id: "unit-18", title: "Unit 18 — Memory"                },
        { id: "unit-19", title: "Unit 19 — Making progress"       },
        { id: "unit-20", title: "Unit 20 — Conflict and violence" },
        { id: "unit-21", title: "Unit 21 — Sound"                 },
      ],
    },
    {
      title: "Section 5 — Functions",
      units: [
        { id: "unit-22", title: "Unit 22 — Supporting and opposing people or views" },
        { id: "unit-23", title: "Unit 23 — Agreeing"                                },
        { id: "unit-24", title: "Unit 24 — Understanding and having ideas"          },
        { id: "unit-25", title: "Unit 25 — Arranging things"                        },
        { id: "unit-26", title: "Unit 26 — Talking about size and number"           },
        { id: "unit-27", title: "Unit 27 — Talking about success and failure"       },
        { id: "unit-28", title: "Unit 28 — Discussing problems"                     },
        { id: "unit-29", title: "Unit 29 — Deciding and influencing"                },
        { id: "unit-30", title: "Unit 30 — Exclamations and warnings"               },
      ],
    },
    {
      title: "Section 6 — Work, Study and Finance",
      units: [
        { id: "unit-31", title: "Unit 31 — Work"                 },
        { id: "unit-32", title: "Unit 32 — Study"                },
        { id: "unit-33", title: "Unit 33 — Lectures and seminars"},
        { id: "unit-34", title: "Unit 34 — Writing essays"       },
        { id: "unit-35", title: "Unit 35 — Business"             },
        { id: "unit-36", title: "Unit 36 — Money"                },
      ],
    },
    {
      title: "Section 7 — Personal Life",
      units: [
        { id: "unit-37", title: "Unit 37 — At home"                      },
        { id: "unit-38", title: "Unit 38 — Clothing and appearance"      },
        { id: "unit-39", title: "Unit 39 — Relationships"                },
        { id: "unit-40", title: "Unit 40 — Character and personal qualities" },
        { id: "unit-41", title: "Unit 41 — Feelings"                     },
        { id: "unit-42", title: "Unit 42 — Social life"                  },
        { id: "unit-43", title: "Unit 43 — Health and symptoms"          },
        { id: "unit-44", title: "Unit 44 — The body"                     },
        { id: "unit-45", title: "Unit 45 — How people speak"             },
        { id: "unit-46", title: "Unit 46 — How people move"              },
      ],
    },
    {
      title: "Section 8 — The World Around Us",
      units: [
        { id: "unit-47", title: "Unit 47 — Nature"        },
        { id: "unit-48", title: "Unit 48 — Weather"       },
        { id: "unit-49", title: "Unit 49 — Places"        },
        { id: "unit-50", title: "Unit 50 — Transport"     },
        { id: "unit-51", title: "Unit 51 — The news"      },
        { id: "unit-52", title: "Unit 52 — Secrets and lies" },
        { id: "unit-53", title: "Unit 53 — Rules and laws"},
        { id: "unit-54", title: "Unit 54 — Technology"   },
        { id: "unit-55", title: "Unit 55 — Food and drink"},
      ],
    },
    {
      title: "Section 9 — Key Verbs",
      units: [
        { id: "unit-56", title: "Unit 56 — Come" },
        { id: "unit-57", title: "Unit 57 — Get"  },
        { id: "unit-58", title: "Unit 58 — Go"   },
        { id: "unit-59", title: "Unit 59 — Keep" },
        { id: "unit-60", title: "Unit 60 — Take" },
      ],
    },
  ],
};
