...
const bookData = {
  ...
  cover:   "/books/social-expressions.jpg",
  subject: "speaking",
  sections: [
    {
      title: "Section 1 — Connecting with People",
      units: [
        { id: "unit-01", num: "01", title: "Telephoning" },
        { id: "unit-02", num: "02", title: "Saying goodbye" },
        { id: "unit-03", num: "03", title: "Making introductions" },
        { id: "unit-04", num: "04", title: "Expressing anxiety" },
        { id: "unit-05", num: "05", title: "Apologizing" },
        { id: "unit-06", num: "06", title: "Local shopping" },
        { id: "unit-07", num: "07", title: "High street shopping" },
        { id: "unit-08", num: "08", title: "Special greetings" },
      ],
    },
    {
      title: "Section 2 — Politeness & Courtesy",
      units: [
        { id: "unit-09", num: "09", title: "Giving thanks" },
        { id: "unit-10", num: "10", title: "Wishing people well" },
        { id: "unit-11", num: "11", title: "Greeting people" },
        { id: "unit-12", num: "12", title: "Discussing intentions" },
        { id: "unit-13", num: "13", title: "Issuing invitations" },
        { id: "unit-14", num: "14", title: "Offering help" },
        { id: "unit-15", num: "15", title: "Asking permission" },
        { id: "unit-16", num: "16", title: "Asking directions" },
      ],
    },
    {
      title: "Section 3 — Out & About",
      units: [
        { id: "unit-17", num: "17", title: "Talking about the weather" },
        { id: "unit-18", num: "18", title: "Going out for dinner" },
        { id: "unit-19", num: "19", title: "Expressing sympathy" },
        { id: "unit-20", num: "20", title: "Going out for coffee" },
        { id: "unit-21", num: "21", title: "Giving warning" },
        { id: "unit-22", num: "22", title: "Expressing likes and dislikes" },
        { id: "unit-23", num: "23", title: "Seeking holiday advice" },
        { id: "unit-24", num: "24", title: "Expressing uncertainty" },
      ],
    },
    {
      title: "Section 4 — Everyday Encounters",
      units: [
        { id: "unit-25", num: "25", title: "Visiting the doctor" },
        { id: "unit-26", num: "26", title: "Expressing pleasure" },
        { id: "unit-27", num: "27", title: "Failing to agree" },
        { id: "unit-28", num: "28", title: "Telling time and dates" },
        { id: "unit-29", num: "29", title: "Paying compliments" },
        { id: "unit-30", num: "30", title: "Making appointments" },
      ],
    },
  ],
};
...
const sectionColors = [
  { accent: "#0891b2", bg: "#ecfeff", badge: "#a5f3fc", text: "#164e63", icon: "🤝" },
  { accent: "#059669", bg: "#f0fdf4", badge: "#a7f3d0", text: "#065f46", icon: "🌸" },
  { accent: "#7c3aed", bg: "#faf5ff", badge: "#ddd6fe", text: "#4c1d95", icon: "🌆" },
  { accent: "#db2777", bg: "#fdf2f8", badge: "#fbcfe8", text: "#831843", icon: "📅" },
];

export default function SocialExpressionsPage() {
    ...
    return (
      <div style={{ fontFamily: "'Manrope', sans-serif", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f9fafb" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ width: "44px", height: "44px", border: "3px solid #a5f3fc", borderTop: "3px solid #0891b2", borderRadius: "50%", animation: "spin 1s linear infinite", margin: "0 auto 16px" }} />
  ...
  return (
    <div style={{ fontFamily: "'Manrope', sans-serif", backgroundColor: "#f9fafb", minHeight: "100vh" }}>
      ...
      {/* ── NAV ── */}
      <nav style={{ backgroundColor: "rgba(255,255,255,0.96)", borderBottom: "1px solid #e0f2fe", position: "fixed", top: 0, width: "100%", zIndex: 50, backdropFilter: "blur(12px)" }}>
        <div style={{ padding: "0 32px", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px", flexWrap: "wrap" }}>
            ...
            <span style={{ color: "#d1d5db" }}>›</span>
            <span style={{ color: "#164e63", fontWeight: 700 }}>Social Expressions</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <Link href="/dashboard" style={{ fontSize: "13px", color: "#6b7280", textDecoration: "none" }}>Dashboard</Link>
            <div style={{ width: "32px", height: "32px", borderRadius: "999px", backgroundColor: "#a5f3fc", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", fontWeight: 700, color: "#164e63" }}>
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "96px 24px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: "28px", alignItems: "start", marginBottom: "40px" }}>
          ...
          <div style={{ width: "140px", aspectRatio: "3/4", backgroundColor: "#e5e7eb", borderRadius: "10px", overflow: "hidden", border: "1px solid #d1d5db", flexShrink: 0 }}>
            ...
            />
            <div style={{ display: "none", width: "100%", height: "100%", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "6px", backgroundColor: "#ecfeff" }}>
          ...
          {/* Info */}
          <div>
            <span style={{ display: "inline-block", fontSize: "11px", fontWeight: 700, backgroundColor: "#a5f3fc", color: "#164e63", padding: "3px 10px", borderRadius: "999px", marginBottom: "10px", letterSpacing: "0.3px" }}>
              SPEAKING
            </span>
            <h1 style={{ fontSize: "26px", fontWeight: 800, color: "#164e63", letterSpacing: "-0.4px", lineHeight: 1.2, marginBottom: "6px" }}>
              {bookData.title}
            </h1>
            ...
            <div style={{ display: "flex", gap: "24px", marginBottom: "20px" }}>
              {[
                ...
                <div key={label}>
                  <p style={{ fontSize: "22px", fontWeight: 800, color: highlight ? "#0891b2" : "#164e63", lineHeight: 1 }}>{val}</p>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              <div style={{ flex: 1, height: "6px", backgroundColor: "#e5e7eb", borderRadius: "999px", overflow: "hidden" }}>
                <div style={{ width: `${(3 / totalUnits) * 100}%`, height: "100%", backgroundColor: "#0891b2", borderRadius: "999px" }} />
              </div>
        ...
        {!isLearner && (
          <div style={{ backgroundColor: "#ecfeff", border: "1px solid #a5f3fc", borderRadius: "10px", padding: "14px 20px", marginBottom: "32px", display: "flex", alignItems: "center", gap: "12px" }}>
            <span style={{ fontSize: "20px" }}>🔒</span>
            <p style={{ fontSize: "13px", color: "#164e63", fontWeight: 500, lineHeight: 1.5 }}>
              Units 1–3 are free.{" "}
              <Link href="/dashboard" style={{ color: "#0891b2", fontWeight: 700, textDecoration: "none" }}>Upgrade to Learner</Link>{" "}
                  ...
                  <div style={{ borderTop: `1px solid ${sc.badge}` }}>
                    {section.units.map((unit, ui) => {
                      ...
                      return (
                        <Link
                          key={unit.id}
                          href={locked ? "#" : `/english/speaking/social-expressions/${unit.id}`}
                          style={{
                            display: "flex",
                            alignItems: "center",
                        ...
                        >
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }}>
                            {isFree && (
                              <span style={{ fontSize: "10px", fontWeight: 700, backgroundColor: "#a5f3fc", color: "#0891b2", padding: "2px 8px", borderRadius: "999px", letterSpacing: "0.2px" }}>
                                FREE
                              </span>
                            )}
                            {locked ? (
        ...
        {/* ── BOTTOM CTA ── */}
        {!isLearner && (
          <div style={{ marginTop: "40px", backgroundColor: "#ecfeff", border: "1px solid #a5f3fc", borderRadius: "12px", padding: "24px", textAlign: "center" }}>
            <p style={{ fontSize: "20px", marginBottom: "8px" }}>🎓</p>
            <p style={{ fontSize: "15px", fontWeight: 700, color: "#164e63", marginBottom: "6px" }}>
              Unlock all {totalUnits} units
            </p>
            <p style={{ fontSize: "13px", color: "#6b7280", marginBottom: "16px" }}>
              Get full access to every unit, Topic explanations, and Practice exercises.
            </p>
            <Link href="/dashboard" style={{ display: "inline-block", backgroundColor: "#0891b2", color: "#ffffff", padding: "10px 28px", borderRadius: "8px", textDecoration: "none", fontSize: "14px", fontWeight: 700 }}>
              Upgrade to Learner
            </Link>
          </div>
        )}
