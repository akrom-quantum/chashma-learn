...
import { getUnit } from "./units/index";
...
export default function UnitClient({ subject, bookId, unitId }) {
  ...
  // Load unit content from registry
    ...
    return (
      <div style={{ fontFamily: "'Manrope', sans-serif", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "#f9f9f8" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: "14px", color: "#9ca3af", marginBottom: "24px" }}>Unit ID: {unitId}</p>
        ...
        <div style={{ flex: 1, display: "flex", minWidth: 0, padding: "48px", alignItems: "flex-start" }}>
          ...
          <div style={{ flex: 1, maxWidth: showRight && activeTab === "topic" ? "680px" : "860px", minWidth: 0 }}>
            ...
            {activeTab === "topic" && (
              <>
                <TopicContent />
                <MarkCompleteBar label="Topic" isDone={topicRead} onMark={handleMarkRead} />
              </>
            )}
            {activeTab === "practice" && (
              <>
                <PracticeContent />
                <MarkCompleteBar label="Practice" isDone={practiceDone} onMark={handleMarkDone} />
              </>
            )}
          </div>
