...
const tabs = [
  ...
  { icon: "spellcheck",           label: "Grammar",            href: "/english/grammar",       free: true, active: true },
  { icon: "translate",            label: "Vocabulary",         href: "/english/vocabulary",    free: false },
  { icon: "record_voice_over",    label: "Pronunciation",      href: "/english/pronunciation", free: false },
  { icon: "link",                 label: "Collocations",       href: "/english/collocations",  free: false },
  { icon: "format_list_bulleted", label: "Phrasal Verbs",      href: "/english/phrasal-verbs", free: false },
  { icon: "auto_stories",         label: "Idioms",             href: "/english/idioms",        free: false },
  { icon: "edit_note",            label: "Writing",            href: "/english/writing",       free: false },
];
      ...
      <div style={{ display: "flex", paddingTop: "64px" }}>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    color: locked ? "#d1d5db" : tab.active ? "#036c48" : "#6b7280",
                ...
                >
                  ...
                  {locked && <span className="material-symbols-outlined" style={{ fontSize: "14px", color: "#d1d5db" }}>lock</span>}
                </Link>
              );
            })}
          </nav>
        ...
        <main style={{ marginLeft: "260px", flex: 1, padding: "48px", maxWidth: "860px" }}>
          ...
          {!isLearner && (
            <div style={{ backgroundColor: "#fffbeb", border: "1px solid #fde68a", borderRadius: "8px", padding: "12px 16px", marginBottom: "24px", display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <p style={{ fontSize: "13px", color: "#92400e", fontWeight: 500 }}>
                Free sample — <Link href="/dashboard" style={{ color: "#036c48", fontWeight: 700 }}>upgrade to Learner</Link> to unlock all content.
              </p>
            </div>
          )}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "24px" }}>
            <span style={{ fontSize: "11px", fontWeight: 700, backgroundColor: "#d1fae5", color: "#036c48", padding: "3px 10px", borderRadius: "999px", textTransform: "uppercase" }}>
              Intermediate B1
            </span>
          ...
          <div style={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: "12px", padding: "32px", marginBottom: "40px" }}>
            ...
            <div style={{ borderTop: "1px solid #f3f4f6", paddingTop: "20px", display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center" }}>
              {[["I ", "have finished", " my work."], ["She ", "has traveled", " to Italy."]].map((ex, i) => (
