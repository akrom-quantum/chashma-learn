  ...
  sections: [
    {
      ...
      units: [
        ...
        { id: "unit-02", num: "02", title: "Using your dictionary" },
      ],
    },
    {
      ...
      icon: "💬",
      units: [
        { id: "unit-03", num: "03", title: "Happiness and sadness" },
        { id: "unit-04", num: "04", title: "Anger" },
        { id: "unit-05", num: "05", title: "Knowing and understanding" },
        { id: "unit-06", num: "06", title: "Experience and perception" },
        { id: "unit-07", num: "07", title: "Success and failure" },
        { id: "unit-08", num: "08", title: "Having problems" },
        { id: "unit-09", num: "09", title: "Dealing with problems" },
        { id: "unit-10", num: "10", title: "Power and authority" },
        { id: "unit-11", num: "11", title: "Structuring and talking about arguments" },
        { id: "unit-12", num: "12", title: "Conversational responses" },
        { id: "unit-13", num: "13", title: "Praise and criticism" },
        { id: "unit-14", num: "14", title: "Opinions on people and actions" },
        { id: "unit-15", num: "15", title: "Behaviour and attitudes" },
        { id: "unit-16", num: "16", title: "Reacting to what others say" },
        { id: "unit-17", num: "17", title: "Danger" },
        { id: "unit-18", num: "18", title: "Effort" },
        { id: "unit-19", num: "19", title: "Necessity and desirability" },
        { id: "unit-20", num: "20", title: "Probability and luck" },
        { id: "unit-21", num: "21", title: "Social status" },
        { id: "unit-22", num: "22", title: "Human relationships" },
        { id: "unit-23", num: "23", title: "Size and position" },
        { id: "unit-24", num: "24", title: "Money" },
        { id: "unit-25", num: "25", title: "Work" },
        { id: "unit-26", num: "26", title: "Speed, distance and intensity" },
        { id: "unit-27", num: "27", title: "Communication 1: words and language" },
        { id: "unit-28", num: "28", title: "Communication 2: expressing yourself" },
        { id: "unit-29", num: "29", title: "Life and experience: proverbs" },
        { id: "unit-30", num: "30", title: "Memory" },
      ],
    },
    
    {
      ...
      icon: "🌐",
      units: [
        { id: "unit-31", num: "31", title: "Time 1: the past and the future" },
        { id: "unit-32", num: "32", title: "Time 2: clocks and frequency" },
        { id: "unit-33", num: "33", title: "The elements" },
        { id: "unit-34", num: "34", title: "Colour" },
        { id: "unit-35", num: "35", title: "Clothes" },
        { id: "unit-36", num: "36", title: "Games and sport" },
        { id: "unit-37", num: "37", title: "Animals 1: describing people" },
        { id: "unit-38", num: "38", title: "Animals 2: describing situations" },
        { id: "unit-39", num: "39", title: "Weapons and war" },
        { id: "unit-40", num: "40", title: "Food" },
        { id: "unit-41", num: "41", title: "Roads" },
        { id: "unit-42", num: "42", title: "Houses and household objects" },
        { id: "unit-43", num: "43", title: "Nature" },
        { id: "unit-44", num: "44", title: "Boats and sailing" },
        { id: "unit-45", num: "45", title: "Science, technology and machines" },
        { id: "unit-46", num: "46", title: "Music and theatre" },
      ],
    },
    {
      ...
      icon: "🔑",
      units: [
        { id: "unit-47", num: "47", title: "Finger, thumb, hand" },
        { id: "unit-48", num: "48", title: "Foot, heel, toe" },
        { id: "unit-49", num: "49", title: "Bones, shoulder, arm, leg" },
        { id: "unit-50", num: "50", title: "Head" },
        { id: "unit-51", num: "51", title: "Face, hair, neck, chest" },
        { id: "unit-52", num: "52", title: "Eyes" },
        { id: "unit-53", num: "53", title: "Ear, lips, mouth, nose, teeth, tongue" },
        { id: "unit-54", num: "54", title: "Heart" },
        { id: "unit-55", num: "55", title: "Brain, mind, blood and guts" },
        { id: "unit-56", num: "56", title: "Back" },
        { id: "unit-57", num: "57", title: "Long" },
        { id: "unit-58", num: "58", title: "Line" },
        { id: "unit-59", num: "59", title: "Act, action, activity" },
        { id: "unit-60", num: "60", title: "Good and bad" },
        { id: "unit-61", num: "61", title: "Ground" },
        { id: "unit-62", num: "62", title: "Similes and idioms with like and as" },
      ],
    },
  ],
};
