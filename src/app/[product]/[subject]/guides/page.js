// src/app/[product]/[subject]/guides/page.js
// Question-type guides index.
...
export default async function GuidesPage({ params }) {
  ...
  return (
    <main style={{ maxWidth: 1000, margin: "0 auto", padding: "48px 24px", fontFamily: "Manrope, sans-serif" }}>
      ...
      <h1 style={{ fontSize: 32, fontWeight: 800, marginBottom: 8 }}>Question Type Guides</h1>
      <p style={{ color: "#6b7280", marginBottom: 32 }}>
        Step-by-step guides for each question type. Authored in Phase 1.
      </p>
