        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px", marginBottom: "40px" }}>
            {[
              ...
              <div key={stat.label}>
                <p style={{ fontSize: "28px", fontWeight: 800, color: "#ffffff", letterSpacing: "-1px" }}>{stat.value}</p>
                <p style={{ fontSize: "12px", color: "#6ee7b7", marginTop: "2px", fontWeight: 500 }}>{stat.label}</p>
              </div>
            ))}
          </div>
      ...
      <div style={{ backgroundColor: "#ffffff", padding: "60px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: "100%", maxWidth: "380px" }}>
          ...
          <form onSubmit={handleEmail} style={{ display: "flex", flexDirection: "column", gap: "16px", marginBottom: "24px" }}>
            <div>
              ...
              <input
                ...
                required
                style={{ width: "100%", padding: "12px 14px", borderRadius: "10px", border: "1px solid #e5e7eb", fontSize: "14px", fontFamily: "'Manrope', sans-serif", outline: "none", backgroundColor: "#fafafa", color: "#111827" }}
              />
            </div>
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  placeholder="••••••••"
                  required
                  style={{ width: "100%", padding: "12px 44px 12px 14px", borderRadius: "10px", border: "1px solid #e5e7eb", fontSize: "14px", fontFamily: "'Manrope', sans-serif", outline: "none", backgroundColor: "#fafafa", color: "#111827" }}
                />
                <button
                  type="button"
                  onClick={() => setShowPass(!showPass)}
                  style={{ position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#9ca3af", fontSize: "13px", fontFamily: "'Manrope', sans-serif" }}
                >
                  {showPass ? "Hide" : "Show"}
                </button>
              </div>
          ...
          <div style={{ marginTop: "32px", paddingTop: "24px", borderTop: "1px solid #f3f4f6", textAlign: "center" }}>
            <Link href="/" style={{ fontSize: "13px", color: "#9ca3af", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "6px" }}>
              ← Back to homepage
            </Link>
          </div>
