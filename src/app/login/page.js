    ...
    <div style={{ fontFamily: "'Manrope', sans-serif", minHeight: "100vh", display: "flex" }}>
      ...
      <div style={{ width: "50%", backgroundColor: "#f9f9f8", padding: "64px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          {/* Google button */}
          <button style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "12px", padding: "12px", borderRadius: "8px", border: "1px solid #e5e7eb", backgroundColor: "#ffffff", fontSize: "14px", fontWeight: 600, color: "#111827", cursor: "pointer", marginBottom: "24px" }}>
          ...
          <button style={{ width: "100%", padding: "14px", borderRadius: "8px", backgroundColor: "#036c48", color: "#ffffff", fontSize: "15px", fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "'Manrope', sans-serif" }}>
            Sign In
          </button>
