...
const modes = [
  { href: "/english", icon: "📖", title: "General English", desc: "Grammar, vocabulary, writing, pronunciation and more", tags: ["Grammar", "Vocabulary", "Writing"], free: true },
  { href: "/ielts",   icon: "🎯", title: "IELTS Academic",  desc: "Complete preparation for all four IELTS skills",      tags: ["Listening", "Reading", "Writing", "Speaking"], free: false },
  { href: "/sat",     icon: "✏️", title: "SAT Preparation", desc: "Digital SAT English, vocabulary and math",            tags: ["English", "Vocabulary", "Math"], free: false },
];
    ...
    <div style={{ fontFamily: "'Manrope', sans-serif", backgroundColor: "#f9fafb", minHeight: "100vh" }}>
      ...
      <nav style={{ backgroundColor: "rgba(255,255,255,0.95)", borderBottom: "1px solid #f0fdf4", position: "fixed", top: 0, width: "100%", zIndex: 50, backdropFilter: "blur(12px)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 32px", height: "68px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <button onClick={handleLogout} style={{ fontSize: "13px", fontWeight: 600, color: "#6b7280", backgroundColor: "transparent", padding: "7px 14px", borderRadius: "8px", border: "1px solid #e5e7eb", cursor: "pointer", fontFamily: "'Manrope', sans-serif" }}>
              Sign Out
            </button>
          </div>
        </div>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "100px 32px 64px" }}>
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <h1 style={{ fontSize: "36px", fontWeight: 800, color: "#064e3b", letterSpacing: "-1px", marginBottom: "8px" }}>{firstName} 👋</h1>
        ...
        {/* My Groups */}
        {isLearner && (
          <Link href="/my-groups" style={{ display: "flex", alignItems: "center", gap: "16px", backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: "12px", padding: "16px 20px", textDecoration: "none", marginBottom: "32px" }}>
          ...
          <div style={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: "12px", padding: "20px 24px", marginBottom: "32px" }}>
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              {[
                ...
                <Link key={a.href} href={a.href} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", borderRadius: "8px", border: "1px solid #e5e7eb", fontSize: "13px", fontWeight: 600, color: "#374151", textDecoration: "none", backgroundColor: "#f9fafb" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
          <p style={{ fontSize: "13px", fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.5px" }}>Learning Modes</p>
          <Link href="/courses" style={{ fontSize: "13px", color: "#036c48", fontWeight: 600, textDecoration: "none" }}>View all →</Link>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "40px" }}>
          {modes.map((mode) => {
            ...
            return (
              <Link key={mode.href} href={locked ? "#" : mode.href} style={{ backgroundColor: "#ffffff", border: "1px solid #e5e7eb", borderRadius: "14px", padding: "24px", textDecoration: "none", display: "flex", flexDirection: "column", gap: "14px", position: "relative", opacity: locked ? 0.6 : 1, cursor: locked ? "not-allowed" : "pointer" }}>
                {locked && (
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                  {mode.tags.map((tag) => (
                    <span key={tag} style={{ fontSize: "11px", fontWeight: 600, padding: "3px 8px", borderRadius: "6px", backgroundColor: "#f3f4f6", color: "#6b7280" }}>{tag}</span>
                  ))}
                </div>
                {!locked && (
